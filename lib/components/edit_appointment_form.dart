...
class _EditAppointmentFormState extends State<EditAppointmentForm> {
  final GlobalKey<FormState> _editAppointmentFormKey = GlobalKey<FormState>();
  ...
  void initState() {
    ...
    _time = Time(
        ...
        second: appointmentData["time"].second);
            ...
            children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 50,
                            child: TextFormField(
                              initialValue: appointmentData["title"],
                              onChanged: (value) => {
                                setState(() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 8, bottom: 16),
                      child: TextFormField(
                        initialValue: appointmentData["desc"],
                        onChanged: (value) => {
                          setState(() {
              ...
              Padding(
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    if (_editAppointmentFormKey.currentState?.validate() ==
                        true) {
                      setState(() {
                        showError = false;
                        handleSubmit();
